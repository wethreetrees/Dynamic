...
Describe "Get-DynamicFunctionParamBlockContent Unit Tests" -Tag Unit {
    ...
    Context "Parameter Tests" {
        ...
        BeforeAll {
            ...
            $commandInfo = InModuleScope -ModuleName Dynamic -ScriptBlock { Get-Command -Name 'Get-DynamicFunctionParamBlockContent' }
        }
...
Describe "Get-DynamicFunctionParamBlockContent Integration Tests" -Tag Integration {
