...
Describe "Get-DynamicFunctionParameterDynamicAttribute Unit Tests" -Tag Unit {
    ...
    Context "Parameter Tests" {
        ...
        BeforeAll {
            ...
            $commandInfo = InModuleScope -ModuleName Dynamic -ScriptBlock { Get-Command -Name 'Get-DynamicFunctionParameterDynamicAttribute' }
        }
...
Describe "Get-DynamicFunctionParameterDynamicAttribute Integration Tests" -Tag Integration {
