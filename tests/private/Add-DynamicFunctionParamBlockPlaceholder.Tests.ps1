...
Describe "Add-DynamicFunctionParamBlockPlaceholder Unit Tests" -Tag Unit {
    ...
    Context "Parameter Tests" {
        ...
        BeforeAll {
            ...
            $commandInfo = InModuleScope -ModuleName Dynamic -ScriptBlock { Get-Command -Name 'Add-DynamicFunctionParamBlockPlaceholder' }
        }
...
Describe "Add-DynamicFunctionParamBlockPlaceholder Integration Tests" -Tag Integration {
