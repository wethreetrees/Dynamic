...
Describe "Assert-DynamicFunctionIsAdvanced Unit Tests" -Tag Unit {
    ...
    Context "Parameter Tests" {
        ...
        BeforeAll {
            ...
            $commandInfo = InModuleScope -ModuleName Dynamic -ScriptBlock { Get-Command -Name 'Assert-DynamicFunctionIsAdvanced' }
        }
...
Describe "Assert-DynamicFunctionIsAdvanced Integration Tests" -Tag Integration {
