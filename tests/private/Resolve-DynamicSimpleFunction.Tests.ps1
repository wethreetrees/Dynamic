...
Describe "Resolve-DynamicSimpleFunction Unit Tests" -Tag Unit {
    ...
    Context "Parameter Tests" {
        ...
        BeforeAll {
            ...
            $commandInfo = InModuleScope -ModuleName Dynamic -ScriptBlock { Get-Command -Name 'Resolve-DynamicSimpleFunction' }
        }
...
Describe "Resolve-DynamicSimpleFunction Integration Tests" -Tag Integration {
