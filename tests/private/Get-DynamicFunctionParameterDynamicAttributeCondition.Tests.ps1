BeforeDiscovery {
    ...
    $parameterTestCases = @(
        @{
            Name      = 'AttributeAst'
            Mandatory = $true
            Type      = [System.Management.Automation.Language.AttributeAst]
        }
    )
...
Describe "Get-DynamicFunctionParameterDynamicAttributeCondition Unit Tests" -Tag Unit {
    ...
    Context "Parameter Tests" {
        ...
        BeforeAll {
            ...
            $commandInfo = InModuleScope -ModuleName Dynamic -ScriptBlock { Get-Command -Name 'Get-DynamicFunctionParameterDynamicAttributeCondition' }
        }
...
Describe "Get-DynamicFunctionParameterDynamicAttributeCondition Integration Tests" -Tag Integration {
